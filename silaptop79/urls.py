...
urlpatterns = [
    ...
    path('hc/assign-laptop/', assign_laptop_hc_view, name='assign_laptop_hc'),
    ...
    path('hc/riwayat-peminjaman/<str:id_laptop>/', riwayatpeminjamanlaptop_hc_view, name='riwayatpeminjamanlaptop_hc'),
    ...
    path('it/riwayat-peminjaman/<str:id_laptop>/', riwayatpeminjamanlaptop_it_view, name='riwayatpeminjamanlaptop_it'),
    ...
    path('it/konfirmasi-pengembalian/', konfirmasi_pengembalian_it_view, name='konfirmasi_pengembalian_it'),
